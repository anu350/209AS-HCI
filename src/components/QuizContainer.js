...
export default function QuizContainer(props) { 
    //const myQuestions = props.ques;  // PASS IN QUESTIONS IN SAME FORMAT AS EXAMPLE QUESTIONS

    //EXAMPLE QUESTIONS -> FILL THESE WITH GENERATED QUESTIONS & ANSWERS
   const questions = [
        {
    ...
    useEffect(() => {
        console.log("First Question Initiated");
        NextQuestion(0);
    }, []);
